<?php
    ...
    function comment_question_insert($username, $ques_id, $content){
        $sql = 'INSERT into question_comment(username, ques_id, content) values(?,?,?)';
        pdo_execute($sql, $username, $ques_id, $content);
    }

    function comment_blog_insert($username, $blog_id, $content){
        $sql = 'INSERT into blog_comment(username, blog_id, content) values(?,?,?)';
        pdo_execute($sql, $username, $blog_id, $content);
    }
    ...
    function comment_lesson_insert($username, $lesson_id, $content){
        $sql = "INSERT into course_comment(username, lesson_id, content) values(?, ?, ?)";
        pdo_execute($sql, $username, $lesson_id, $content);
    }
